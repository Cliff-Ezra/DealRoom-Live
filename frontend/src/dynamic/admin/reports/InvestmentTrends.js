...
const investmentData = [
  { month: "January", newInvestments: 10, totalFundsInvested: "$100,000" },
  { month: "February", newInvestments: 15, totalFundsInvested: "$150,000" },
  { month: "March", newInvestments: 5, totalFundsInvested: "$50,000" },
  { month: "April", newInvestments: 20, totalFundsInvested: "$200,000" },
  { month: "May", newInvestments: 22, totalFundsInvested: "$220,000" },
  { month: "June", newInvestments: 24, totalFundsInvested: "$240,000" },
  { month: "July", newInvestments: 14, totalFundsInvested: "$140,000" },
  { month: "August", newInvestments: 15, totalFundsInvested: "$150,000" },
  { month: "September", newInvestments: 5, totalFundsInvested: "$50,000" },
  { month: "October", newInvestments: 20, totalFundsInvested: "$200,000" },
  { month: "November", newInvestments: 22, totalFundsInvested: "$220,000" },
  { month: "December", newInvestments: 24, totalFundsInvested: "$240,000" },
];
  ...
  return (
    <>
      <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
        ...
        <Box sx={{ flexGrow: 1 }} />
        <Tooltip title="This report shows the Investment Trends">
      ...
      {/* Report Bar Chart */}
      <Card>
        <CardHeader title="Investment Trends" />
        <CardContent>
          <Chart
            height={350}
                ...
                <TableBody>
                  {investmentData.map((row) => (
                    <TableRow key={row.month}>
                      ...
                      <TableCell>{row.newInvestments}</TableCell>
                      <TableCell>{row.totalFundsInvested}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
